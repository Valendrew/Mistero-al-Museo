			...
			<Card.Header>
				<Row>
					...
					{questionsArray.length === 0 ? (
						<Col xs={6} md={4} lg={2}>
							<DropdownInputs allowedInputs={props.questionsInputs} handleAddInput={props.handleAddInput} category={"questions"} />
						</Col>
					) : (
						<Col xs={2} sm={1}>
							<RemoveButton id={Object.entries(props.questions)[0][0]} category={"questions"} handleRemoveInput={props.handleRemoveInput} />
						</Col>
					)}
				</Row>
			</Card.Header>
					...
					<Card.Body>
						...
						<Tabs defaultActiveKey="answers">
							...
							<Tab eventKey="tips" title="Suggerimenti">
								<Tips questionId={key} rangeId={val.tipsRange} tips={val.tips} inputs={props.inputs} handleInput={props.handleInput} />
							</Tab>
						</Tabs>
					</Card.Body>
				);
